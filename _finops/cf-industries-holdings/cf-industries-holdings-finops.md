...
description: FinOps framework definition for the CF Industries Holdings API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: CF Industries Holdings
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: CF Industries Holdings
  PublisherName: CF Industries Holdings
  ServiceCategory: Developer Tools / API
  ServiceName: CF Industries Holdings
layout: finops
meters:
- aggregation: sum
...
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: CF Industries Holdings\nproviderId: cf-industries-holdings\npublisherName: CF Industries Holdings\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Agriculture\n  - Ammonia\n  - Chemicals\n  - Clean Energy\n  - Fertilizer\n  - Fortune 500\n  - Hydrogen\n  - Investor Relations\n  - Low-Carbon\n  - Manufacturing\n  - Nitrogen\n  - Supply Chain\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the CF Industries Holdings API surface. Provides a FOCUS-aligned\n  mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API\
  ...
  \ sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\n      - region\n      - consumer\n  - name: data_egress\n    description: Bytes returned over the network in API responses\n    unit: GB\n    aggregation: sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: CF Industries Investor Relations Data\n    baseURL: ''\n    tags:\n      - EDGAR\n      - Earnings\n      - Financial\n      - Investor\n      - SEC\n    serviceName: CF Industries Investor Relations Data\n    serviceCategory: API\n  - name: CF Industries EDI / B2B Supply Chain\n    baseURL: ''\n    tags:\n      - B2B\n      - EDI\n      - Rail\n      - Supply Chain\n    serviceName: CF Industries EDI / B2B Supply Chain\n    serviceCategory: API\nunitEconomics:\n  - name: Cost\
