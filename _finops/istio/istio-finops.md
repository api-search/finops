...
description: FinOps framework definition for the Istio API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Istio
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Istio
  PublisherName: Istio
...
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Istio\nproviderId: istio\npublisherName: Istio\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - CNCF\n  - Kubernetes\n  - Microservices\n  - Open Source\n  - Service Mesh\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Istio API surface. Provides a FOCUS-aligned mapping for\n  cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible to engineering, product, and finance teams in near\n      real-time.\n  - name: Allocation\n    description: Tag every chargeable API call with the consuming team,\
  ...
  \    - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Istio Networking API\n    baseURL: ''\n    tags:\n      - Networking\n      - Service Mesh\n      - Traffic Management\n    serviceName: Istio Networking API\n    serviceCategory: API\n  - name: Istio Security API\n    baseURL: ''\n    tags:\n      - Authentication\n      - Authorization\n      - Security\n      - Service Mesh\n    serviceName: Istio Security API\n    serviceCategory: API\n  - name: Istio Telemetry API\n    baseURL: ''\n    tags:\n      - Metrics\n      - Observability\n      - Service Mesh\n      - Telemetry\n      - Tracing\n    serviceName: Istio Telemetry API\n    serviceCategory: API\n  - name: Istio Extensions API\n    baseURL: ''\n    tags:\n      - Extensions\n      - Service Mesh\n      - Wasm\n      - WebAssembly\n\
  \    serviceName: Istio Extensions API\n    serviceCategory: API\n  - name: Istio Mesh Config API\n    baseURL: ''\n    tags:\n      - Configuration\n      - Networking\n      - Proxy\n      - Service Mesh\n    serviceName: Istio Mesh Config API\n    serviceCategory: API\n  - name: Istio Operator API\n    baseURL: ''\n    tags:\n      - Installation\n      - Kubernetes\n      - Operator\n      - Service Mesh\n    serviceName: Istio Operator API\n    serviceCategory: API\nunitEconomics:\n  - name: Cost per 1K Requests\n    metric: billed_cost / (api_requests / 1000)\n    target: TBD\n  - name: Cost per Active Consumer\n    metric: billed_cost / active_consumers\n    target: TBD\nmaintainers:\n  - FN: Kin Lane\n    email: kin@apievangelist.com\n"
