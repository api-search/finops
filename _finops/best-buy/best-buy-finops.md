...
description: FinOps framework definition for the Best Buy API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Best Buy
  PricingCategory: Usage-Based
  PricingUnit: request
...
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Best Buy\nproviderId: best-buy\npublisherName: Best Buy\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Retail\n  - Consumer Electronics\n  - E-Commerce\n  - Products\n  - Stores\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Best Buy API surface. Provides a FOCUS-aligned mapping\n  for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible to engineering, product, and finance teams in near\n      real-time.\n  - name: Allocation\n    description: Tag every chargeable API call with the\
  ...
  \    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Best Buy Products API\n    baseURL: ''\n    tags:\n      - Products\n      - Retail\n      - Electronics\n      - Pricing\n      - Inventory\n    serviceName: Best Buy Products API\n    serviceCategory: API\n  - name: Best Buy Stores API\n    baseURL: ''\n    tags:\n      - Stores\n      - Locations\n      - Retail\n      - Geolocation\n    serviceName: Best Buy Stores API\n    serviceCategory: API\n  - name: Best Buy Categories API\n    baseURL: ''\n    tags:\n      - Categories\n      - Taxonomy\n      - Products\n    serviceName: Best Buy Categories API\n    serviceCategory: API\n  - name: Best Buy Recommendations API\n    baseURL: ''\n    tags:\n      - Recommendations\n      - Personalization\n\
  \      - Products\n    serviceName: Best Buy Recommendations API\n    serviceCategory: API\n  - name: Best Buy Buying Options (Open Box) API\n    baseURL: ''\n    tags:\n      - Open Box\n      - Refurbished\n      - Discounts\n      - Products\n    serviceName: Best Buy Buying Options (Open Box) API\n    serviceCategory: API\n  - name: Best Buy Commerce API\n    baseURL: ''\n    tags:\n      - Commerce\n      - Orders\n      - Fulfillment\n      - Partners\n    serviceName: Best Buy Commerce API\n    serviceCategory: API\nunitEconomics:\n  - name: Cost per 1K Requests\n    metric: billed_cost / (api_requests / 1000)\n    target: TBD\n  - name: Cost per Active Consumer\n    metric: billed_cost / active_consumers\n    target: TBD\nmaintainers:\n  - FN: Kin Lane\n    email: kin@apievangelist.com\n"
