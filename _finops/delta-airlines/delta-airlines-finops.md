...
description: FinOps framework definition for the Delta Airlines API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Delta Airlines
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Delta Airlines
  PublisherName: Delta Airlines
  ServiceCategory: Developer Tools / API
  ServiceName: Delta Airlines
layout: finops
meters:
- aggregation: sum
