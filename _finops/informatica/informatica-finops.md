...
description: FinOps framework definition for the Informatica API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Informatica
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Informatica
  PublisherName: Informatica
...
source_url: ''
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Informatica\nproviderId: informatica\npublisherName: Informatica\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Address Verification\n  - B2B Gateway\n  - Cloud Services\n  - Data Governance\n  - Data Integration\n  - Data Profiling\n  - Data Quality\n  - Enterprise Software\n  - ETL\n  - IDMC\n  - IICS\n  - Master Data Management\n  - Reference Data Management\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Informatica API surface. Provides a FOCUS-aligned mapping\n  for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description:\
  ...
  \ api\n      - endpoint\n      - tier\n      - region\n      - consumer\n  - name: data_egress\n    description: Bytes returned over the network in API responses\n    unit: GB\n    aggregation: sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Informatica Platform REST API\n    baseURL: ''\n    tags:\n      - Authentication\n      - Platform\n      - Roles\n      - Users\n    serviceName: Informatica Platform REST API\n    serviceCategory: API\n  - name: Informatica Data Integration REST API\n    baseURL: ''\n    tags:\n      - Connections\n      - Data Integration\n      - ETL\n      - Mappings\n    serviceName: Informatica Data Integration REST API\n    serviceCategory: API\n  - name: Informatica Cloud Data Governance and Catalog API\n    baseURL:\
  \ ''\n    tags:\n      - Data Catalog\n      - Data Governance\n    serviceName: Informatica Cloud Data Governance and Catalog API\n    serviceCategory: API\n  - name: Informatica Cloud Data Profiling REST API\n    baseURL: ''\n    tags:\n      - Data Profiling\n      - Data Quality\n    serviceName: Informatica Cloud Data Profiling REST API\n    serviceCategory: API\n  - name: Informatica Cloud Address Verification API\n    baseURL: ''\n    tags:\n      - Address Verification\n      - Data Quality\n    serviceName: Informatica Cloud Address Verification API\n    serviceCategory: API\n  - name: Informatica B2B Gateway REST API\n    baseURL: ''\n    tags:\n      - B2B\n      - EDI\n      - Gateway\n    serviceName: Informatica B2B Gateway REST API\n    serviceCategory: API\n  - name: Informatica Reference 360 REST API\n    baseURL: ''\n    tags:\n      - Master Data Management\n      - Reference Data\n    serviceName: Informatica Reference 360 REST API\n    serviceCategory: API\nunitEconomics:\n\
