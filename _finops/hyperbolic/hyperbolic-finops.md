...
description: FOCUS-aligned FinOps placeholder for Hyperbolic. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Hyperbolic
  ProviderName: Hyperbolic
  PublisherName: Hyperbolic
  ServiceCategory: AI
  ServiceName: Hyperbolic
layout: finops
meters:
- aggregation: sum
...
publisher_name: Hyperbolic
service_category: AI
slug: hyperbolic-finops
source_filename: hyperbolic-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/finops/hyperbolic-finops.yml
sources:
- https://hyperbolic.xyz/
- https://focus.finops.org/focus-specification/v1-3/
