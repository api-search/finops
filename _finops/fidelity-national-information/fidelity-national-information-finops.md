...
description: FinOps framework definition for the Fidelity National Information Services (FIS) API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Fidelity National Information Services (FIS)
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Fidelity National Information Services (FIS)
  PublisherName: Fidelity National Information Services (FIS)
  ServiceCategory: Developer Tools / API
  ServiceName: Fidelity National Information Services (FIS)
layout: finops
meters:
- aggregation: sum
