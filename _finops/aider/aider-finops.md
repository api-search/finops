...
description: FOCUS-aligned FinOps placeholder for Aider. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Aider
  ProviderName: Aider
  PublisherName: Aider
  ServiceCategory: AI
  ServiceName: Aider
...
provider_name: Aider
provider_slug: aider
publisher_name: Aider
service_category: AI
slug: aider-finops
source_filename: aider-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/aider/refs/heads/main/finops/aider-finops.yml
sources:
- https://aider.chat/
- https://focus.finops.org/focus-specification/v1-3/
