...
description: FinOps framework definition for the Knight-Swift Transportation API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Knight-Swift Transportation
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Knight-Swift Transportation
  PublisherName: Knight-Swift Transportation
