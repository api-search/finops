...
description: FOCUS-aligned FinOps scaffold for JPMorgan Chase Payments / Treasury APIs. Treated as a per-transaction banking model with negotiated client pricing.
focus_columns:
  BillingCurrency: USD
