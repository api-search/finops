...
description: FinOps framework definition for the Scrapfly API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Scrapfly
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Scrapfly
  PublisherName: Scrapfly
...
publisher_name: Scrapfly
service_category: API
slug: scrapfly-finops
source_filename: scrapfly-finops.yml
source_heading: FinOps Profile
source_url: ''
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Scrapfly\nproviderId: scrapfly\npublisherName: Scrapfly\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - AI\n  - Data Extraction\n  - Screenshots\n  - Web Scraping\n  - Proxies\n  - Browser Automation\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Scrapfly API surface. Provides a FOCUS-aligned mapping\n  for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible to engineering, product, and finance teams in near\n      real-time.\n  - name: Allocation\n    description: Tag every chargeable\
  ...
  \ sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Scrapfly Scrape API\n    baseURL: ''\n    tags:\n      - Web Scraping\n      - Anti-Bot\n      - Proxies\n      - JavaScript Rendering\n    serviceName: Scrapfly Scrape API\n    serviceCategory: API\n  - name: Scrapfly Screenshot API\n    baseURL: ''\n    tags:\n      - Screenshots\n      - Web Scraping\n      - Browser Automation\n    serviceName: Scrapfly Screenshot API\n    serviceCategory: API\n  - name: Scrapfly Extraction API\n    baseURL: ''\n    tags:\n      - Data Extraction\n      - AI\n      - Structured Data\n    serviceName: Scrapfly Extraction API\n    serviceCategory: API\n  - name: Scrapfly Crawler API\n    baseURL: ''\n    tags:\n      - Web Crawling\n      - Data Collection\n\
  \      - WARC\n    serviceName: Scrapfly Crawler API\n    serviceCategory: API\n  - name: Scrapfly Cloud Browser API\n    baseURL: ''\n    tags:\n      - Browser Automation\n      - Playwright\n      - Puppeteer\n      - Selenium\n    serviceName: Scrapfly Cloud Browser API\n    serviceCategory: API\n  - name: Scrapfly SDKs\n    baseURL: ''\n    tags:\n      - SDK\n      - Python\n      - TypeScript\n      - Go\n      - Rust\n    serviceName: Scrapfly SDKs\n    serviceCategory: API\nunitEconomics:\n  - name: Cost per 1K Requests\n    metric: billed_cost / (api_requests / 1000)\n    target: TBD\n  - name: Cost per Active Consumer\n    metric: billed_cost / active_consumers\n    target: TBD\nmaintainers:\n  - FN: Kin Lane\n    email: kin@apievangelist.com\n"
