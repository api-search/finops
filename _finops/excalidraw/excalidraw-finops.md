...
description: FOCUS-aligned FinOps placeholder for Excalidraw. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Excalidraw
  ProviderName: Excalidraw
  PublisherName: Excalidraw
...
- aggregation: sum
  ...
  name: api_usage
  unit: varies
name: Excalidraw Finops
provider_name: Excalidraw
provider_slug: excalidraw
publisher_name: Excalidraw
service_category: Collaboration
slug: excalidraw-finops
source_filename: excalidraw-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/excalidraw/refs/heads/main/finops/excalidraw-finops.yml
sources:
- https://excalidraw.com/
- https://focus.finops.org/focus-specification/v1-3/
