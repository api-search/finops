...
description: FOCUS-aligned FinOps placeholder for Milvus. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Milvus
  ProviderName: Milvus
  PublisherName: Milvus
...
publisher_name: Milvus
service_category: Vector Database
slug: milvus-finops
source_filename: milvus-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/milvus/refs/heads/main/finops/milvus-finops.yml
sources:
- https://milvus.io/
- https://focus.finops.org/focus-specification/v1-3/
