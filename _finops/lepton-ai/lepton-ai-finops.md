...
description: FOCUS-aligned FinOps placeholder for Lepton AI. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Lepton AI
  ProviderName: Lepton AI
  PublisherName: Lepton AI
  ServiceCategory: AI
  ServiceName: Lepton AI
layout: finops
meters:
- aggregation: sum
...
publisher_name: Lepton AI
service_category: AI
slug: lepton-ai-finops
source_filename: lepton-ai-finops.yml
source_heading: FinOps Profile
source_url: https://www.lepton.ai/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/lepton-ai/refs/heads/main/finops/lepton-ai-finops.yml
sources:
- https://www.lepton.ai/
- https://focus.finops.org/focus-specification/v1-3/
