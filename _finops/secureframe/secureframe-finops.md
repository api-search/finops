...
description: FOCUS-aligned FinOps placeholder for Secureframe. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Secureframe
  ProviderName: Secureframe
  PublisherName: Secureframe
  ServiceCategory: GRC
  ServiceName: Secureframe
layout: finops
meters:
- aggregation: sum
...
publisher_name: Secureframe
service_category: GRC
slug: secureframe-finops
source_filename: secureframe-finops.yml
source_heading: FinOps Profile
source_url: https://secureframe.com/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/secureframe/refs/heads/main/finops/secureframe-finops.yml
sources:
- https://secureframe.com/
- https://focus.finops.org/focus-specification/v1-3/
