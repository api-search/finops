...
description: FinOps framework definition for the Veeva Systems API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Veeva Systems
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Veeva Systems
  PublisherName: Veeva Systems
  ServiceCategory: Developer Tools / API
  ServiceName: Veeva Systems
layout: finops
meters:
- aggregation: sum
