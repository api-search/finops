...
description: FinOps framework definition for the CommScope Holding API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: CommScope Holding
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: CommScope Holding
  PublisherName: CommScope Holding
  ServiceCategory: Developer Tools / API
  ServiceName: CommScope Holding
layout: finops
meters:
- aggregation: sum
