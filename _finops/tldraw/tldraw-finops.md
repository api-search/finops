...
description: FOCUS-aligned FinOps placeholder for tldraw. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: tldraw
  ProviderName: tldraw
  PublisherName: tldraw
...
publisher_name: tldraw
service_category: Collaboration
slug: tldraw-finops
source_filename: tldraw-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/tldraw/refs/heads/main/finops/tldraw-finops.yml
sources:
- https://www.tldraw.com/
- https://focus.finops.org/focus-specification/v1-3/
