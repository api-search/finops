...
description: FinOps framework definition for the Laboratory Corporation of America (Labcorp) API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Laboratory Corporation of America (Labcorp)
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Laboratory Corporation of America (Labcorp)
  PublisherName: Laboratory Corporation of America (Labcorp)
  ServiceCategory: Developer Tools / API
  ServiceName: Laboratory Corporation of America (Labcorp)
layout: finops
meters:
- aggregation: sum
...
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Laboratory Corporation of America (Labcorp)\nproviderId: laboratory-corp-of-america\npublisherName: Laboratory Corporation of America (Labcorp)\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Alias\n  - Diagnostics\n  - FHIR\n  - Fortune 500\n  - Healthcare\n  - Laboratory\n  - Life Sciences\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Laboratory Corporation of America (Labcorp) API surface.\n  Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting\n  across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible\
  ...
  \ API requests\n    unit: request\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\n      - region\n      - consumer\n  - name: data_egress\n    description: Bytes returned over the network in API responses\n    unit: GB\n    aggregation: sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Labcorp FHIR API\n    baseURL: ''\n    tags:\n      - FHIR\n      - HL7\n      - Healthcare\n      - Interoperability\n      - Laboratory\n    serviceName: Labcorp FHIR API\n    serviceCategory: API\n  - name: Labcorp Link Provider Integration\n    baseURL: ''\n    tags:\n      - EHR\n      - Healthcare\n      - Orders\n      - Results\n    serviceName: Labcorp Link Provider Integration\n    serviceCategory: API\nunitEconomics:\n\
