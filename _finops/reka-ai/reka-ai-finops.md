...
description: FOCUS-aligned FinOps placeholder for Reka AI. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Reka AI
  ProviderName: Reka AI
  PublisherName: Reka AI
  ServiceCategory: AI
  ServiceName: Reka AI
layout: finops
meters:
...
publisher_name: Reka AI
service_category: AI
slug: reka-ai-finops
source_filename: reka-ai-finops.yml
source_heading: FinOps Profile
source_url: https://www.reka.ai/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/reka-ai/refs/heads/main/finops/reka-ai-finops.yml
sources:
- https://www.reka.ai/
- https://focus.finops.org/focus-specification/v1-3/
