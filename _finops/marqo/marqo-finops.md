...
description: FOCUS-aligned FinOps placeholder for Marqo. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Marqo
  ProviderName: Marqo
  PublisherName: Marqo
...
provider_name: Marqo
provider_slug: marqo
publisher_name: Marqo
service_category: Vector Database
slug: marqo-finops
source_filename: marqo-finops.yml
source_heading: FinOps Profile
source_url: https://www.marqo.ai/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/marqo/refs/heads/main/finops/marqo-finops.yml
sources:
- https://www.marqo.ai/
- https://focus.finops.org/focus-specification/v1-3/
