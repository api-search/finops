...
description: FinOps framework definition for the F5 Load Balancer API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: F5 Load Balancer
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: F5 Load Balancer
  PublisherName: F5 Load Balancer
  ServiceCategory: Developer Tools / API
  ServiceName: F5 Load Balancer
layout: finops
meters:
- aggregation: sum
