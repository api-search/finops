...
description: FinOps framework definition for the TechCrunch API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: TechCrunch
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: TechCrunch
  PublisherName: TechCrunch
  ServiceCategory: Developer Tools / API
  ServiceName: TechCrunch
layout: finops
meters:
- aggregation: sum
...
source_filename: techcrunch-finops.yml
source_heading: FinOps Profile
source_url: ''
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: TechCrunch\nproviderId: techcrunch\npublisherName: TechCrunch\nserviceCategory: API\ncreated: '2026-05-04'\nmodified: '2026-05-04'\ntags:\n  - Media\n  - News\n  - Startups\n  - Technology News\n  - Venture Capital\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the TechCrunch API surface. Provides a FOCUS-aligned mapping\n  for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible to engineering, product, and finance teams in near\n      real-time.\n  - name: Allocation\n    description: Tag every chargeable API call with\
  ...
  \ sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: TechCrunch WordPress REST API\n    baseURL: https://techcrunch.com/wp-json/wp/v2\n    tags:\n      - Content\n      - JSON\n      - Media\n      - REST\n      - WordPress\n    serviceName: TechCrunch WordPress REST API\n    serviceCategory: API\n  - name: TechCrunch RSS Feed\n    baseURL: https://techcrunch.com\n    tags:\n      - Feed\n      - News\n      - RSS\n      - Syndication\n    serviceName: TechCrunch RSS Feed\n    serviceCategory: API\nunitEconomics:\n  - name: Cost per 1K Requests\n    metric: billed_cost / (api_requests / 1000)\n    target: TBD\n  - name: Cost per Active Consumer\n    metric: billed_cost / active_consumers\n    target: TBD\nmaintainers:\n  - FN: Kin Lane\n    email:\
  \ kin@apievangelist.com\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/techcrunch/refs/heads/main/finops/techcrunch-finops.yml
sources: []
