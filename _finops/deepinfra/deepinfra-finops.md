...
description: FOCUS-aligned FinOps placeholder for DeepInfra. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: DeepInfra
  ProviderName: DeepInfra
  PublisherName: DeepInfra
  ServiceCategory: AI
...
publisher_name: DeepInfra
service_category: AI
slug: deepinfra-finops
source_filename: deepinfra-finops.yml
source_heading: FinOps Profile
source_url: https://deepinfra.com/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/deepinfra/refs/heads/main/finops/deepinfra-finops.yml
sources:
- https://deepinfra.com/
- https://focus.finops.org/focus-specification/v1-3/
