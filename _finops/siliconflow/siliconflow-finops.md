...
description: FOCUS-aligned FinOps placeholder for SiliconFlow. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: SiliconFlow
  ProviderName: SiliconFlow
  PublisherName: SiliconFlow
  ServiceCategory: AI
...
publisher_name: SiliconFlow
service_category: AI
slug: siliconflow-finops
source_filename: siliconflow-finops.yml
source_heading: FinOps Profile
source_url: https://siliconflow.com/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/siliconflow/refs/heads/main/finops/siliconflow-finops.yml
sources:
- https://siliconflow.com/
- https://focus.finops.org/focus-specification/v1-3/
