...
description: FinOps framework definition for the Chicago Transit Authority API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Chicago Transit Authority
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Chicago Transit Authority
  PublisherName: Chicago Transit Authority
  ServiceCategory: Developer Tools / API
  ServiceName: Chicago Transit Authority
layout: finops
meters:
- aggregation: sum
...
source_filename: chicago-transit-authority-finops.yml
source_heading: FinOps Profile
source_url: ''
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Chicago Transit Authority\nproviderId: chicago-transit-authority\npublisherName: Chicago Transit Authority\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Bus\n  - Bus Tracker\n  - Chicago\n  - CTA\n  - Customer Alerts\n  - GTFS\n  - L Train\n  - Open Data\n  - Public Transit\n  - Real-Time\n  - Train\n  - Train Tracker\n  - Transit\n  - Transportation\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Chicago Transit Authority API surface. Provides a FOCUS-aligned\n  mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description:\
