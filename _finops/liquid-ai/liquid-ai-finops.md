...
description: FOCUS-aligned FinOps placeholder for Liquid AI. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Liquid AI
  ProviderName: Liquid AI
  PublisherName: Liquid AI
  ServiceCategory: AI
  ServiceName: Liquid AI
layout: finops
meters:
- aggregation: sum
...
publisher_name: Liquid AI
service_category: AI
slug: liquid-ai-finops
source_filename: liquid-ai-finops.yml
source_heading: FinOps Profile
source_url: https://www.liquid.ai/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/liquid-ai/refs/heads/main/finops/liquid-ai-finops.yml
sources:
- https://www.liquid.ai/
- https://focus.finops.org/focus-specification/v1-3/
