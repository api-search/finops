...
description: FOCUS-aligned FinOps placeholder for Drata. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Drata
  ProviderName: Drata
  PublisherName: Drata
  ServiceCategory: GRC
  ServiceName: Drata
...
provider_name: Drata
provider_slug: drata
publisher_name: Drata
service_category: GRC
slug: drata-finops
source_filename: drata-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/drata/refs/heads/main/finops/drata-finops.yml
sources:
- https://drata.com/
- https://focus.finops.org/focus-specification/v1-3/
