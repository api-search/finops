...
description: FOCUS-aligned FinOps placeholder for Cline. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Cline
  ProviderName: Cline
  PublisherName: Cline
  ServiceCategory: AI
  ServiceName: Cline
...
provider_name: Cline
provider_slug: cline
publisher_name: Cline
service_category: AI
slug: cline-finops
source_filename: cline-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/cline/refs/heads/main/finops/cline-finops.yml
sources:
- https://cline.bot/
- https://focus.finops.org/focus-specification/v1-3/
