...
description: FOCUS-aligned FinOps placeholder for Vespa. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Vespa
  ProviderName: Vespa
  PublisherName: Vespa
...
provider_name: Vespa
provider_slug: vespa
publisher_name: Vespa
service_category: Vector Database
slug: vespa-finops
source_filename: vespa-finops.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/vespa/refs/heads/main/finops/vespa-finops.yml
sources:
- https://vespa.ai/
- https://focus.finops.org/focus-specification/v1-3/
