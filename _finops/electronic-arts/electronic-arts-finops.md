...
description: FinOps framework definition for the Electronic Arts API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Electronic Arts
  PricingCategory: Usage-Based
  PricingUnit: request
  ProviderName: Electronic Arts
  PublisherName: Electronic Arts
  ServiceCategory: Developer Tools / API
  ServiceName: Electronic Arts
layout: finops
meters:
- aggregation: sum
