...
description: FOCUS-aligned FinOps for Delta Air Lines APIs (scaffold). Distribution APIs typically follow per-shop and per-book transaction economics under negotiated NDC / partner agreements. No public per-call price exists.
focus_columns:
  BillingCurrency: USD
