...
description: FOCUS-aligned FinOps placeholder for project44. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: project44
  ProviderName: project44
  PublisherName: project44
