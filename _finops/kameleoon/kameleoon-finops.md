...
description: FinOps framework definition for the Kameleoon API surface. Provides a FOCUS-aligned mapping for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.
focus_columns:
  BillingCurrency: USD
...
source_yaml: "specification: FinOps Framework\nspecificationVersion: '1.0'\nalignedWith:\n  framework: FinOps Foundation Framework\n  frameworkUrl: https://www.finops.org/framework/\n  dataSpec: FOCUS\n  dataSpecVersion: '1.3'\n  dataSpecUrl: https://focus.finops.org/focus-specification/v1-3/\nprovider: Kameleoon\nproviderId: kameleoon\npublisherName: Kameleoon\nserviceCategory: API\ncreated: '2026-05-08'\nmodified: '2026-05-08'\ntags:\n  - Experimentation\n  - AB Testing\n  - Personalization\n  - Feature Flags\n  - AI\n  - FinOps\n  - Cost Management\n  - FOCUS\ndescription: FinOps framework definition for the Kameleoon API surface. Provides a FOCUS-aligned mapping\n  for cost allocation, usage measurement, and unit-economics reporting across the provider's APIs.\nprinciples:\n  - name: Visibility\n    description: Make API consumption costs visible to engineering, product, and finance teams in near\n      real-time.\n  - name: Allocation\n    description: Tag every chargeable API call\
  ...
  \ sum\n    dimensions:\n      - api\n      - region\n      - consumer\n  - name: compute_seconds\n    description: Server-side compute consumed by the request, where applicable\n    unit: second\n    aggregation: sum\n    dimensions:\n      - api\n      - endpoint\n      - tier\napis:\n  - name: Kameleoon Automation API\n    baseURL: https://api.kameleoon.com/automation/v1\n    tags:\n      - Experimentation\n      - Automation\n      - REST\n    serviceName: Kameleoon Automation API\n    serviceCategory: API\n  - name: Kameleoon Data API\n    baseURL: https://data.kameleoon.io\n    tags:\n      - Experimentation\n      - Data\n      - REST\n    serviceName: Kameleoon Data API\n    serviceCategory: API\n  - name: Kameleoon Product Recommendation API\n    baseURL: https://api.kameleoon.com/recommendation/v1\n    tags:\n      - Recommendations\n      - AI\n      - REST\n    serviceName: Kameleoon Product Recommendation API\n    serviceCategory: API\nunitEconomics:\n  - name: Cost per 1K\
