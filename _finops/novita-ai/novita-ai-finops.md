...
description: FOCUS-aligned FinOps placeholder for Novita AI. Pipeline will replace with real billing details.
focus_columns:
  BillingCurrency: USD
  ChargeCategory: Usage
  InvoiceIssuerName: Novita AI
  ProviderName: Novita AI
  PublisherName: Novita AI
  ServiceCategory: AI
  ServiceName: Novita AI
layout: finops
meters:
- aggregation: sum
...
publisher_name: Novita AI
service_category: AI
slug: novita-ai-finops
source_filename: novita-ai-finops.yml
source_heading: FinOps Profile
source_url: https://novita.ai/
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/novita-ai/refs/heads/main/finops/novita-ai-finops.yml
sources:
- https://novita.ai/
- https://focus.finops.org/focus-specification/v1-3/
